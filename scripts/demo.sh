...
LV="$(curl -s https://api.github.com/repos/ggml-org/llama.cpp/releases/latest | python -c 'import sys,json;print(json.load(sys.stdin)["tag_name"])')"
